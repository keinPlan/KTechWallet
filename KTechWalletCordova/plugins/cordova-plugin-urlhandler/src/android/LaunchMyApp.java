...
public class LaunchMyApp extends CordovaPlugin {
  ...
  public void onNewIntent(Intent intent) {
    ...
    if (intentString != null && intentString.contains("://")) {
      intent.setData(null);
      try {	 
		    String protocol = intentString.substring(0 ,intentString.indexOf("://") +3 );
		    intentString = intentString.substring(intentString.indexOf("://") +3  );
	    	intentString =  protocol +  URLDecoder.decode(intentString, "UTF-8");
